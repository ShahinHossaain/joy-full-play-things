...
const EngineeringCategoryToys = () => {
  const [toys, setToys] = useState(null);
  useEffect(() => {
    fetch(
      "https://joy-full-play-things-server.vercel.app/toys?subCategory=Engineering%20Toys&sort=1"
    )
      .then((res) => res.json())
...
export default EngineeringCategoryToys;
